          ...
          <div className="min-h-[100vh] w-full max-w-[1440px] mx-auto bg-primary px-6 text-textColor flex flex-col">
            ...
            <nav className="flex items-center justify-between">
              ...
              >
                ...
                <div className={clsx(!isGeneral ? 'mt-[12px]' : 'min-w-[80px]')}>
                  {isGeneral ? 'AHA Social Manager' : 'Gitroom'}
                </div>
              </Link>
              {user?.orgId &&
              ...
              >
                <Link
                  href="/legal"
                  className="hidden md:inline text-sm text-customColor17 hover:underline"
                >
