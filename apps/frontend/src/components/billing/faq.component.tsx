  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by AHA Social Manager?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information AHA Social Manager will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'AHA Social Manager (based on Postiz)' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'AHA Social Manager (a fork of Postiz)' : 'Gitroom'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'this project' : 'Gitroom'
        } will live forever. You can check out the entire code or use it for personal projects. To view the original Postiz open-source repository, <a href="https://github.com/gitroomhq/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      ...
      description: t(
        ...
        `${
          isGeneral ? 'AHA Social Manager (based on Postiz)' : 'Gitroom'
